...
# Place unified legend below the plots in the center
fig.legend(handles, labels, loc='lower center', bbox_to_anchor=(0.5, -0.15), ncol=2, fontsize=11, framealpha=0.9)
