...
def plot_single_score(score_name: str, output_pdf: str, color: str) -> None:
    ...
    ax.set_xlabel('Graph Building Method', fontsize=14, fontweight='bold')
    ax.set_ylabel('Score Value', fontsize=14, fontweight='bold')
    ax.set_title(f'SCIB Evaluation: {score_name}', fontsize=16, fontweight='bold')
    ax.set_xticks(x)
    ax.set_xticklabels(all_method_keys, rotation=45, ha='right', fontsize=12)
