"""
Plot SCIB evaluation results (mesenchymal): separate plots for Total, Batch correction, Bio conservation.
...
def plot_single_score(score_name: str, output_pdf: str, colors: tuple[str, str]) -> None:
    ...
    ax.set_title(f'SCIB Evaluation (Mesenchymal): {score_name}', fontweight='bold')
    ax.set_xticks(x)
