"""
Run CellDiffusion integration with specific k_mnn (n_edges_per_node = k_mnn)
"""
import sys
...
print(f"Integration for k_mnn={params.k_mnn} (n_edges_per_node={params.n_edges_per_node})")
...
print(f"\n=== CellDiffusion integration complete for k_mnn={params.k_mnn} (n_edges_per_node={params.n_edges_per_node})! ===")
