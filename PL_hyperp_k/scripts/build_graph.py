"""
Build integration graph with specific k_mnn value
"""
import sys
...
print(f"Using k_mnn={params.k_mnn}")
...
# Build integration graph with specific k_mnn
print(f"\n=== Building integration graph with k_mnn={params.k_mnn} ===")
