"""
Build integration graph with specific n_edges_per_node value
"""
import sys
...
print(f"Using n_edges_per_node={params.n_edges_per_node}, k_mnn={params.k_mnn}")
...
# Build integration graph with specific n_edges_per_node (k_mnn is fixed)
print(f"\n=== Building integration graph with n_edges_per_node={params.n_edges_per_node}, k_mnn={params.k_mnn} ===")
