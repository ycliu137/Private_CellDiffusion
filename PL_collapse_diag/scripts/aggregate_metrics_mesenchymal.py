"""
Aggregate neighbor purity metrics from all Mesenchymal lineage evaluations
"""
import sys
...
print(f"\n=== Aggregating Mesenchymal lineage metrics from {len(input_csv_files)} files ===")
...
print(f"\n=== Aggregated results (Mesenchymal lineage) ===")
