"""
Build graph, integrate with CellDiffusion, and compute UMAP in one step to reduce file I/O
Combines build_graph.py, integrate_celldiffusion.py, and compute_umap.py
"""
import sys
...
print(f"Number of diffusion steps: {params.num_steps_diffusion}")
...
print(f"\n=== Complete pipeline for CellDiffusion (nsteps={params.num_steps_diffusion}) finished! ===")
