"""
SCIB evaluation for Mesenchymal lineage cells only: benchmark CellDiffusion and GCN embeddings across different network layers
"""
import sys
...
# Get all X_dif_nsteps* and X_gcn_nlayers* embeddings
...
if len(embedding_keys) == 0:
    raise ValueError("No embeddings found matching patterns 'X_dif_nsteps*' or 'X_gcn_nlayers*' in adata.obsm")
