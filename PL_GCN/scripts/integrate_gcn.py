...
print(f"  Encoder: None (using default)")
print(f"  Decoder: None (using default)")
...
cd.inte.integration_gcn(
    ...
    encoder=None,  # Use default: [D_in, num_features_gcn] if needed
    decoder=None,  # Use default: [num_features_gcn, D_out] if needed
    save_model=False,
