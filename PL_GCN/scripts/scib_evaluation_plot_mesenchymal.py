"""
Plot SCIB evaluation results for Mesenchymal lineage cells: bar plot comparing CellDiffusion vs GCN aggregate scores
"""
import sys
...
ax.set_title('SCIB Evaluation (Mesenchymal Lineage): CellDiffusion vs GCN - Aggregate Scores Comparison', fontsize=14, fontweight='bold')
ax.set_xticks(x)
