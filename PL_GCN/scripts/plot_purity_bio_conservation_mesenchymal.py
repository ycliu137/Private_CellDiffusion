"""
Plot neighbor purity and bio conservation score for Mesenchymal lineage cells in the same bar plot
"""
import sys
...
ax.set_title('Neighbor Purity and Bio Conservation (Mesenchymal Lineage): CellDiffusion vs GCN', fontsize=14, fontweight='bold')
ax.set_xticks(x)
